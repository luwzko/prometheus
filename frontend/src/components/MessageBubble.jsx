        ...
        <div className="flex justify-start">
            <div className="max-w-[75%] glass-card rounded-2xl overflow-hidden shadow-sm">
                ...
                {hasExecuted && showExecuted && executedSteps && (
                    <div className="px-6 pb-4 space-y-2 border-t border-white/25 bg-gray-50/10 pt-4">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        {step?.action_request && (
                                            <div className="mt-2 pt-2 border-t border-white/25">
                                                <div className="text-xs text-gray-500 mb-1">
                                                    <span className="font-mono text-gray-900">{step.action_request?.action_name || 'Unknown'}</span>
                                        ...
                                        {step?.action_output && (
                                            <div className="mt-2 pt-2 border-t border-white/25">
                                                ...
                                                <div className="text-xs font-mono text-gray-900 break-words whitespace-pre-wrap">
                ...
                {/* Reflection Section */}
                {hasReflection && (
                    <div className="px-6 py-3 border-t border-white/25 bg-gray-50/15">
                        <div className="flex items-start justify-between gap-3">
                            ...
                            {reflection.control && (
                                <button
                                    ...
                                    className="flex-shrink-0 p-1.5 rounded-lg hover:bg-gray-200/50 transition-colors"
                                    title="Error Control"
                                >
                                    <svg 
                        ...
                        {showErrorControl && reflection.control && (
                            <div className="mt-3 pt-3 border-t border-white/25 space-y-2">
                                <div className="flex items-center gap-2">
                                    <span className="text-xs font-medium text-gray-600 w-24">Error Detected:</span>
                                    <span className={`text-xs font-semibold ${
                                        reflection.control.error_detected ? 'text-red-600' : 'text-green-600'
                                    }`}>
                                ...
                                {reflection.control.error_reason && (
                                    <div className="flex items-start gap-2">
                                        <span className="text-xs font-medium text-gray-600 w-24 flex-shrink-0">Error Reason:</span>
                                ...
                                {reflection.control.recommended_action && (
                                    <div className="flex items-start gap-2">
                                        <span className="text-xs font-medium text-gray-600 w-24 flex-shrink-0">Recommended:</span>
                                        <span className="text-xs text-gray-900 flex-1">
                                            {reflection.control.recommended_action}
                                        </span>
                                    </div>
                ...
                {rawResponse?.action_output && !hasExecuted && (
                    <div className="px-6 py-3 border-t border-white/25 bg-gray-50/10">
                        <div className="text-xs font-semibold text-gray-700 uppercase tracking-wide mb-2">
                            Action Output
                        </div>
